  ...
  describe('Queue', () => {
    ...
    describe('#remove()', () => {
      ...
      it('should remove the first occurrence of a value', () => {
        let q = new Queue<number>([0, 1, 2, 1, 3]);
        q.remove(1);
        expect(q.front).to.be(0);
        expect(q.back).to.be(3);
    ...
    describe('#removeAll()', () => {
      ...
      it('should remove all occurrences of a value', () => {
        let q1 = new Queue<number>([0, 1, 2, 1, 3]);
        q1.removeAll(1);
        ...
        let q2 = new Queue<number>([0, 1, 2, 1, 0]);
        q2.removeAll(0);
      ...
      it('should return the number of occurrences removed', () => {
        ...
        let q2 = new Queue<number>([0, 1, 0, 1, 0]);
    ...
    describe('#forEach()', () => {
      ...
      it('should return the first non-`undefined` result', () => {
        let values: number[] = [];
        let q = new Queue<number>([0, 1, 2, 3]);
        let r = q.forEach(v => { values.push(v); if (v == 2) return true; });
        expect(r).to.be(true);
      });
